        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="frontend/html/guestView/english/guestLandingEnglish.html.php">Inglés</a></li>
              <li><a class="dropdown-item" href="frontend/html/guestView/english/guestLandingEnglish.html.php">Árabe</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-person-circle"></i></a>
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="frontend/html/guestView/spanish/login.html.php">Log In</a></li>
            </ul>
          </li>
        </ul>
      </div>

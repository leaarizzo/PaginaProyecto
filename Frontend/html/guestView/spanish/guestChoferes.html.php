            ...
            <div class="col-md-3">
                <div class="chofer-card">
                    ...
                    <div class="chofer-info">
                        ...
                        <p class="chofer-details">Experiencia: Con más de tres décadas en las pistas, Lewis ha dejado una marca indeleble en la historia del automovilismo.</p>
            ...
            <div class="col-md-3">
                <div class="chofer-card">
                    ...
                    <div class="chofer-info">
                        ...
                        <p class="chofer-details">Experiencia: Max ha trabajado para Luxury Driving desde 2021 y es uno de nuestros instructores más destacados.</p>
                        <button class="btn-disponibilidad">VER DISPONIBILIDAD</button>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="chofer-card">
                    ...
                    <div class="chofer-info">
                        ...
                        <p class="chofer-details">Experiencia: Charles trabaja para Luxury Driving desde 2019 y es especialista en conducción de precisión.</p>
                        <button class="btn-disponibilidad">VER DISPONIBILIDAD</button>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="chofer-card">
                    ...
                    <div class="chofer-info">
                        ...
                        <p class="chofer-details">Experiencia: Logan trabaja para Luxury Driving desde 2022 y es nuestro especialista en técnicas de conducción defensiva.</p>
                        <button class="btn-disponibilidad">VER DISPONIBILIDAD</button>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-abajo">
                    ...
                    <a href="../../guestView/spanish/guestLandingSpanish.html.php" class="footer-logo">
                        <img src="../../../img/logo.png" alt="Logo" width="200" height="67">
                    </a>

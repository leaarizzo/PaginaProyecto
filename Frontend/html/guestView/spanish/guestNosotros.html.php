...
<body class="body2">
  ...
  <div class="contentNos">
    <div>
        ...
        <p class="info">Ser reconocidos como la empresa líder en clases de conducción en Uruguay, distinguiéndonos por nuestro compromiso con la excelencia, la innovación y la adaptación a las necesidades de nuestros alumnos. Aspiramos a ser un referente nacional en la enseñanza de conducción, estableciendo los más altos estándares en la formación de conductores y contribuyendo al desarrollo de una sociedad más segura en las vías.</p>
        
        <h2 class="Subtitulo">Propósito</h2>
        <p class="info">Nuestro propósito es empoderar a los uruguayos para que alcancen su máximo potencial como conductores, brindándoles las herramientas y conocimientos necesarios para dominar el arte de la conducción. Nos enfocamos en cultivar su confianza, habilidades técnicas y comprensión de las normas de tránsito, al mismo tiempo que fomentamos un profundo respeto por la seguridad vial y la responsabilidad al volante. Nuestro objetivo es formar conductores competentes y comprometidos con la prevención de accidentes, promoviendo así un entorno más seguro para todos los usuarios de las vías en Uruguay.</p>
        
        <h2 class="Subtitulo">Misión</h2>
        <p class="info">Nuestra misión es brindar una formación integral y de alta calidad en conducción a todos los uruguayos, fomentando una cultura de seguridad vial y respeto por las normas de tránsito. Nos esforzamos por formar conductores responsables, hábiles y seguros, capaces de enfrentar cualquier situación en las carreteras con confianza y profesionalismo.</p>

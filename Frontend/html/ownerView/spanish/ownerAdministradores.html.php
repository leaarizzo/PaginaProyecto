                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <h2 class="card-title text-uppercase mb-0"> ADMINISTRADORES </h2>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Añadir nuevo Administrador </h5>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary" onclick="agregarAdministrador()">Guardar</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript" src="../../../js/manejoAdministradores.js"></script>
